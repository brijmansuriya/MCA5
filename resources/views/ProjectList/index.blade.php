                    ...
                    <div class="col-md-12">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="header-action d-md-flex">
                                ...
                                <div>
                                <a href="ProjectList/add">
                                    <button type="text" class="btn btn-info">Add</button>
                                </a>    
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6 col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title"> {{ $post->project_title }}</h3>
                                    ...
                                    <div class="card-body">
                                        <span class="tag tag-blue mb-3">{{ $post->technology_used }}</span>
                                        <p>{{ $post->description }}</p>
                                        <div class="row">
                                            <div class="col-5 py-1"><strong>Technology Used:</strong></div>
                                            <div class="col-7 py-1">{{ $post->technology_used }}</div>
