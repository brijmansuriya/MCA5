<div id="header_top" class="header_top">
    <div class="container">
        <div class="hleft">
            <a class="header-brand" href="index.php"><i class="fa fa-soccer-ball-o brand-logo"></i></a>
        </div>
        <div class="hright">
            <div class="dropdown">
...
<div id="left-sidebar" class="sidebar ">
    <h5 class="brand-name">IT<a href="javascript:void(0)" class="menu_option float-right"><i
    ...
    <nav id="left-sidebar-nav" class="sidebar-nav">
        <ul class="metismenu">
            ...
            <li><a href="{{url('ProjectList')}}"><i class="fa fa-list-ol"></i><span>Project list</span></a></li>
            ...
            <li>
                <a href="javascript:void(0)" class="has-arrow arrow-c"><i
                        class="fa fa-lock"></i><span>HRMS</span></a>
                <ul>
